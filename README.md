...
RESULT --> [PrivateTicketingDebug.sol](https://github.com/plucena/data\_privacy\_framework/blob/main/solidity/PrivateTicketingDebug.sol)solidity/PrivateTicketingDebug.sol
